...
class Downloads : AppCompatActivity(),SwipeRefreshLayout.OnRefreshListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar.title = getString(R.string.saver)
    ...
    fun FileQuery() {
        ...
        arrayList!!.clear()
        path = Environment.getExternalStorageDirectory().absolutePath + "/singsave"
        ...
        observable!!.subscribeOn(Schedulers.io())
                ...
                .subscribe(object: Observer<String> {
                    override fun onComplete() {
                        ...
                        adapter = Photo_Adapter(applicationContext, arrayList!!, this@Downloads)
...
class Photo_Adapter(var context: Context, var arraylists: ArrayList<Photo_Model>, var downloads: Downloads) :
    ...
    class Item(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bindData(_data: Photo_Model, _cube: Downloads) {
